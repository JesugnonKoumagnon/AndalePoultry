  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-16">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <h1 className="text-4xl font-heading font-bold tracking-tight">À propos d'AgriVolaille</h1>

        <div className="space-y-4 text-foreground/80 leading-relaxed text-base">
          <p>
            <strong>AgriVolaille</strong> est une plateforme de gestion avicole complète, conçue pour aider les éleveurs de volailles — qu'ils soient petits producteurs familiaux ou exploitations industrielles — à piloter leur activité au quotidien avec précision et sérénité.
          </p>
          <p>
            Grâce à AgriVolaille, vous pouvez suivre vos bandes de poulets, pintades, canards, dindes et cailles en temps réel : effectifs, mortalités, poids moyens, traitements sanitaires, consommation d'aliments et rentabilité par bande. Tous vos indicateurs clés sont centralisés dans un tableau de bord clair et intuitif.
          </p>
          <p>
          ...
          <p>
            AgriVolaille est développé par une équipe passionnée par l'agriculture africaine et les technologies numériques, avec pour mission de rendre la gestion avicole professionnelle accessible à tous les éleveurs, où qu'ils se trouvent.
          </p>
        </div>
